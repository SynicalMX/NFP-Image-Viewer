	...
	context.subscriptions.push(vscode.commands.registerCommand('nfp-images.dispNFP', () => {
		...
		if (fileExt === "nfp") {
			const panel = vscode.window.createWebviewPanel(
				'nfpImageView', // Identifies the type of the webview. Used internally
...
// Gets file extension
// Ex. file.TXT => txt
function getFileExt(filename: any) {
...
function getWebviewContent(image: Array<string>) {
